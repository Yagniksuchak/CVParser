...
#clean with Recruitment_Specialty_Type_recode.xlsx
...
#, DROP recruitment_specialties_name_6,
...
DROP TABLE IF EXISTS final.job_all2;
CREATE TABLE final.job_all2
SELECT a.* ,
...
UPDATE table1 dest, (SELECT * FROM table2 where id=x) src 
  SET cv = 1 where src.filename in ('cv', 'CV') ;
